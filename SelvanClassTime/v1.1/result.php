...
<body>
  ...
  <hr id="hr" style="height: 3px;background-color: black;">
  <button class='btn btn-danger' style='margin:20 0 20 20 ;' onclick="deleteData()">
    Delete All Data
  </button>
  <a href="./" style="white-space: nowrap;padding: 20;padding-bottom: 1000px;">Go Back to Previous Page</a>
</body>
