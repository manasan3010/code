...
//$query_stampdutyfirst = "SELECT stampdutyfirst.* FROM stampdutyfirst WHERE stampdutyfirst.dataentrydate >= date('" . $startdate->format('Y-m-d') ."') and stampdutyfirst.dataentrydate <= date('" . $enddate->format('Y-m-d') . "') and stampdutyfirst.localauthorityid=35 order by date";
...
<h1>Unidentified Slips <?php echo $selectedyear.' - '.date('F',strtotime($_GET['reportdate'])); ?>  </h1>
