...
<table id="myTable" width="auto" border="1" class="hovertable">
  <tr>
    ...
    <td><input type="text" id="myInput10" onkeyup="myFunction(10)" size="5"/></td>
    <td><input type="text" id="myInput11" onkeyup="myFunction(11)" size="5"/></td>
    <td><input type="text" id="myInput12" onkeyup="myFunction(12)" size="5"/></td>
    <td><input type="text" id="myInput13" onkeyup="myFunction(13)" size="5"/></td>
    <td>From<input type="date" id="myInputfrom14" onchange="myFunctionfromto(14)" placeholder="Date From" size="5"/><br />To
    <input type="date" id="myInputto14" onchange="myFunctionfromto(1)" placeholder="Date To"size="5"/></td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td>
      <a href="sd103dateupdate.php?fileno=<?php echo $row_stampdutyfirst['id']; ?>&amp;address1=<?php echo $row_stampdutyfirst['grantoraddress']; ?>&amp;loyer=<?php echo $row_stampdutyfirst['loyername']; ?>&amp;deeddate=<?php echo $row_stampdutyfirst['deeddate']; ?>&amp;deedno=<?php echo $row_stampdutyfirst['deedno']; ?>&amp;receiver=<?php echo $row_stampdutyfirst['granteename']; ?>">SD103</a>
      
      <a href="sd103dateupdate.php?fileno=<?php echo $row_stampdutyfirst['id']; ?>&amp;address1=<?php echo $row_stampdutyfirst['grantoraddress']; ?>&amp;loyer=<?php echo $row_stampdutyfirst['loyername']; ?>&amp;deeddate=<?php echo $row_stampdutyfirst['deeddate']; ?>&amp;deedno=<?php echo $row_stampdutyfirst['deedno']; ?>&amp;receiver=<?php echo $row_stampdutyfirst['granteename']; ?>"></a> <?php echo ' '.$row_stampdutyfirst['sd103date']; ?>
	  
      </td>
      <td><a href="sd104up.php?fileno=<?php echo $row_stampdutyfirst['id']; ?>&amp;deeddate=<?php echo $row_stampdutyfirst['deeddate']; ?>&amp;loyer=<?php echo $row_stampdutyfirst['loyername']; ?>&amp;sd103date=<?php echo $row_stampdutyfirst['sd103date']; ?>&amp;address=<?php echo $row_stampdutyfirst['granteeaddress']; ?>&amp;receiver=<?php echo $row_stampdutyfirst['granteename']; ?>&amp;deedno=<?php echo $row_stampdutyfirst['deedno']; ?>">SD104 </a><a href="sd104up.php?fileno=<?php echo $row_stampdutyfirst['id']; ?>&amp;address=<?php echo $row_stampdutyfirst['grantoraddress']; ?>&amp;loyer=<?php echo $row_stampdutyfirst['loyername']; ?>&amp;deeddate=<?php echo $row_stampdutyfirst['deeddate']; ?>&amp;deedno=<?php echo $row_stampdutyfirst['deedno']; ?>&amp;receiver=<?php echo $row_stampdutyfirst['granteename']; ?>"></a> <?php echo ' '.$row_stampdutyfirst['sd104date']; ?></td>
      <td> <a href="sd105form.php?id=<?php echo $row_stampdutyfirst['id']; ?>">SD105</a>
