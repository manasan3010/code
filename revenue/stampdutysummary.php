...
<table id="myTable"  border="1" class="hovertable">
  <tr>
    ...
    <td><input type="text" id="myInput14" onkeyup="myFunction(14)" size="5"/></td>
    <td>From<input type="date" id="myInputfrom15" onchange="myFunctionfromto(15)" placeholder="Date From" size="5"/><br />To
    <input type="date" id="myInputto15" onchange="myFunctionfromto(15)" placeholder="Date To"size="5"/></td>
  ...
  ?>
    ...
    <tr>
      ...
      <td>
      <a href="sd103dateupdate.php?fileno=<?php echo $row_stampdutyfirst['fileno']; ?>&amp;address1=<?php echo $row_stampdutyfirst['grantoraddress']; ?>&amp;loyer=<?php echo $row_stampdutyfirst['loyername']; ?>&amp;deeddate=<?php echo $row_stampdutyfirst['deeddate']; ?>&amp;deedno=<?php echo $row_stampdutyfirst['deedno']; ?>&amp;receiver=<?php echo $row_stampdutyfirst['granteename']; ?>">SD103</a>
 ...
 <?php echo ' '.$row_stampdutyfirst['sd105date'].' '; ?>     
      ...
      <td><a href="sd150form.php?fileno=<?php echo $row_stampdutyfirst['fileno']; ?>"> SD150</a></td>
    </tr>
