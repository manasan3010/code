...
$query_Recordset1 = "SELECT * FROM stampduty where stampduty.date = date('" . $startdate->format('Y-m-d') ."') ORDER BY address3 ASC";
...
<body>
<h1>Additional Stamp Duty Summary <?php echo $_GET['reportdate']; ?></h1>
