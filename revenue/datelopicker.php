...
if ($_SESSION['MM_UserID']<35){
	$query_localauthority = "SELECT * FROM localauthorities WHERE id=" . $_SESSION['MM_UserID'];
	}
...
<form id="form1" name="form1" method="get" action="stampdutymonthlyreportps.php">
  <p>
