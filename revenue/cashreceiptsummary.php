...
<table  id="myTable" class="hovertable">
  <tr>
    <td>&nbsp;</td>
    <td><input type="date" id="myInput1" onchange="myFunction(1)" placeholder="Search for date.." /></td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_cash['reason']. ' ' . $row_cash['fileno']; ?></td>
      <td><a href="cashreceiptprint.php?receiptID=<?php echo $row_cash['receiptID']; ?>"><img src="printlogo.jpg" width="25" height="25" /></a></td>
      <td><a href="updatecashreceipt.php?receiptID=<?php echo $row_cash['receiptID']; ?>"><img src="edit_icon.jpg" width="25" height="25" alt="Edit" /></a></td>
    </tr>
