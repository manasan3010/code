...
<input type='text' name='{$fields.last_name_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_mobile_advanced'>{sugar_translate label='LBL_MOBILE_PHONE' module='Contacts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.phone_mobile_advanced.name}' id='{$fields.phone_mobile_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='0'	  class="phone" >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='department_advanced'>{sugar_translate label='LBL_DEPARTMENT' module='Contacts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.department_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_work_advanced'>{sugar_translate label='LBL_OFFICE_PHONE' module='Contacts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.phone_work_advanced.name}' id='{$fields.phone_work_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='0'	  class="phone" >
