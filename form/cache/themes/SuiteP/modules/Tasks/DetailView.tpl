...
{if !$fields.assigned_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.assigned_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.assigned_c.name}" value="{ $fields.assigned_c.options }">
{ $fields.assigned_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.assigned_c.name}" value="{ $fields.assigned_c.value }">
{ $fields.assigned_c.options[$fields.assigned_c.value]}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.serial_no_c.name}">{$fields.serial_no_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.model_name_c.name}">{$fields.model_name_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TASK_NUMBER' module='Tasks'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.task_number_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.task_number_c.value) <= 0}
{assign var="value" value=$fields.task_number_c.default_value }
{else}
{assign var="value" value=$fields.task_number_c.value }
{/if} 
<span class="sugar_field" id="{$fields.task_number_c.name}">{$fields.task_number_c.value}</span>
{/if}
