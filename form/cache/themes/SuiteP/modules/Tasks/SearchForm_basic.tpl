...
value="1" title='' tabindex="" {$checked} >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='date_entered_basic' >{sugar_translate label='LBL_DATE_ENTERED' module='Tasks'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
{rdelim}
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='task_number_c_basic' >{sugar_translate label='LBL_TASK_NUMBER' module='Tasks'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.task_number_c_basic.value) <= 0}
{assign var="value" value=$fields.task_number_c_basic.default_value }
{else}
{assign var="value" value=$fields.task_number_c_basic.value }
{/if}  
<input type='text' name='{$fields.task_number_c_basic.name}' 
    id='{$fields.task_number_c_basic.name}' size='30' 
    maxlength='80' 
    value='{$value}' title='Task ID Number'      >
		</div>
		<div class="search-clear"></div>
	</div>
</div>
