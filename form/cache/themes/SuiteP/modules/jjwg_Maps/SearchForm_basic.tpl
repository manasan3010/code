...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> {sugar_translate label='LBL_NAME' module='jjwg_Maps'}</label>
					</div>
...
{html_options id='module_type_basic' name='module_type_basic[]' options=$fields.module_type_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.module_type_basic.value}
		</div>
		<div class="search-clear"></div>
	</div>
