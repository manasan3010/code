...
{sugar_translate label='DEFAULT' module='jjwg_Maps'}
</div>
</a>
</div>
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.unit_type.name}-input', '{$fields.unit_type.name}');sync_{$fields.unit_type.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.module_type.name}-input', '{$fields.module_type.name}');sync_{$fields.module_type.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
