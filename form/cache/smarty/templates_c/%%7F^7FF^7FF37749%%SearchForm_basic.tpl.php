...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='date_entered_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Tasks'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
").focus();
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='task_number_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TASK_NUMBER','module' => 'Tasks'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php if (strlen ( $this->_tpl_vars['fields']['task_number_c_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['task_number_c_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['task_number_c_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['task_number_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['task_number_c_basic']['name']; ?>
' size='30' 
    maxlength='80' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='Task ID Number'      >
		</div>
		<div class="search-clear"></div>
	</div>
</div>
