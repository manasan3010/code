...
<div class="card shadow " style="margin:0px 20px" id="tableHolder">
  <div class="card-header py-3">
    <span class="m-0 mr-4 font-weight-bold text-primary">Edit Products</span><a href="javascript:redrawTable();" class="mt-2 mt-sm-0 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-redo fa-sm text-white-50 mr-1"></i> Refresh Table</a>
  </div>
  <div class="card-body">
