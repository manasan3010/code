var ourList = document.getElementsByTagName('li');
...
button.addEventListener("click",sd)

function sd(){
list.innerHTML+= "<li>ourList()</li>"
ourList[ourList.length-1].innerHTML=inWords(ourList.length)+" item"
}
